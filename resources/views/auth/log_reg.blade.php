...
<div id="app">
    <nav class="navbar navbar-expand-md shadow-sm" style="background-color: #ed3015">
        <div class="container">
		...
		<div class="white-panel">
			<div class="login-show">
                ...
                @enderror
				 ...
				 <button class="btn btn-outline-danger" type="submit" value="Login">
                    {{ __('Login') }}
                 </button>
			...
			<div class="register-show">
				...
				<button class="btn btn-outline-danger" type="submit" value="Register">
                    {{ __('Register') }}
                </button>
			</div>
		</div>
